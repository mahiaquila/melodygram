...
import com.melodygram.adapter.ImageAdapter;
import com.melodygram.utils.ItemOffsetDecoration;
...
public class MultiPhotoSelectActivity extends Activity
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
        ...
        backButton=(RelativeLayout)findViewById(R.id.header_back_button_parent);
	...
	public void btnChoosePhotosClick(View v)
	{
		...
		if (selectedItems!= null && selectedItems.size() > 0)
		{
			...
			String selectImages = selectedItems.toString().replace("[","");
            String brachesSelectedIamge = selectImages.replace("]","");
			Intent i = new Intent();
			i.putExtra("data", brachesSelectedIamge);
			setResult(Activity.RESULT_OK, i);
			finish();
		}else
		{
			Toast.makeText(MultiPhotoSelectActivity.this, "photo is not selected", Toast.LENGTH_SHORT).show();
