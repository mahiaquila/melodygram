 ...
 */
public class AWSMediaDownloaderSender extends AsyncTask<String, String, String> {
    ...
    public AWSMediaDownloaderSender(String mediaStoragePath, Context mediaActivity, String msgId, String type) {
