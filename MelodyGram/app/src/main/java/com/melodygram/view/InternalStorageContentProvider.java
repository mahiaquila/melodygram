...
//		try {
//			File mFile = new File(getContext().getFilesDir(), ProfileFragment.TEMP_PHOTO_FILE_NAME);
//			if(!mFile.exists()) {
//				mFile.createNewFile();
...
//		File f = new File(getContext().getFilesDir(), ProfileFragment.TEMP_PHOTO_FILE_NAME);
//		if (f.exists()) {
